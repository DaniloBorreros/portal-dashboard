...
import { role, studentsData } from "@/_lib/data";
...
const StudentListPage = async () => {
  ...
  const renderRow = (item: StudentList) => (
    ...
    >
      ...
      <td className="hidden md:table-cell text-center">{item.studentNumber}</td>
      <td className="hidden md:table-cell text-center">{item.yearLevel}</td>
